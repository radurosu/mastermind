...
public class depthSearch{
 ...
 //       testCompareFunction();
    ...
    /*    spVector = new Vector();
        ...
        spVector.addElement(sp1);
        spVector.addElement(sp2);
        spVector.addElement(sp3);
*/
    ...
    public mmResult compareCodes(mmCode a, mmCode b){
        ...
        int j;
/*
        if(a.getPositions() != b.getPositions()){
            System.err.println("Codes given to Compare codes we of differnt lenghts");
            return thisResult;
        }
*/
 ...
 //arrayOfSums = new int[vectorSize];
 ...
 // System.out.println(/*"geting minimum of set with size" + */vectorSize);
 // printVector(thisSet);
 ...
 //mmCode tmp =(mmCode)remaingCodes.elementAt(i);
 //tmp.print();
 ...
 /*       printVector(spVector);
        if(level ==2){
            resultTable[0][3].addElement(spVector.elementAt(0));
            resultTable[1][2].addElement(spVector.elementAt(1));
            resultTable[2][1].addElement(spVector.elementAt(2));
            resultTable[2][0].addElement(spVector.elementAt(2));
            resultTable[3][0].addElement(spVector.elementAt(2));
            printVector(resultTable[3][0]);
        }*/
        //now we have an array of vectors readdy to be given to getMinimumOfSet
        // so.......
  ...
  /*System.out.println("Geting minimum of: ");
  for(int i = 0 ; i < resultTable[blacks][whites].size() ; i++)
  {  mmCode tmp = new mmCode(positions);
     tmp = (mmCode)resultTable[blacks][whites].elementAt(i);
     tmp.print();
  }*/
 ...
 //  System.out.println("min of:" + min + " sum:" + sum);
                    }
                }
            }
//   System.out.print("\n");
