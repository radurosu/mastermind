...
public final class msmindFrame extends Frame
{
	...
	public void msmindFrame()
	{
		...
		buffer=createImage(240,250); // Prepare drawing buffers
		bufg=buffer.getGraphics();
		peg=createImage(48,40);  // Used for drawing peg symbol
		pegg=peg.getGraphics();
		resize(240,250);   // resizes the applet area to look nice
		clearBoard();
	}
